...
- [X] Provide a tocify-markdown minor mode
- [X] Follow link in toc: M-x tocify-markdown-follow-toc-link-at-point
...
- [X] Make tocify-markdown-header-toc-* customizable - Closes #26
- [X] Update version
- [X] Release notes
...
- [X] Add tocify-markdown-bug-report command
- [X] Release notes
...
- [X] Add prefix argument to `tocify-markdown/generate-toc' to replace existing TOC at the same location #10
...
- [X] Use directly tocify-markdown, no need to require anything
...
- [X] Add COPYING file + licence inside tocify-markdown.el
...
- [X] Update an existing TOC
  ...
  - [X] Remove old TOC
  - [X] Create new one
- [X] Reference tocify-markdown version
...
- [X] Release notes
- [X] Deploy to Melpa -> make recipe + PR to them - https://github.com/ardumont/melpa/blob/add-tocify-markdown/recipes/tocify-markdown
